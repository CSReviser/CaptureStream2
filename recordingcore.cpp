...
QString RecordingCore::scramble;
QString RecordingCore::optional1;
QString RecordingCore::optional2;
QString RecordingCore::optional3;
QString RecordingCore::optional4;
QString RecordingCore::optional5;
QString RecordingCore::optional6;
QString RecordingCore::optional7;
QString RecordingCore::optional8;
QString RecordingCore::special1;
QString RecordingCore::special2;
QString RecordingCore::special3;
QString RecordingCore::special4;
QString RecordingCore::opt_title1;
QString RecordingCore::opt_title2;
QString RecordingCore::opt_title3;
QString RecordingCore::opt_title4;
QString RecordingCore::opt_title5;
QString RecordingCore::opt_title6;
QString RecordingCore::opt_title7;
QString RecordingCore::opt_title8;
...
//	this->ui = ui;
	...
	if ( ffmpegHash.empty() ) {
		...
		ffmpegHash["mp3-40k-S"] = "%1,-id3v2_version,3,-write_xing,0,-metadata,title=%3,-metadata,artist=NHK,-metadata,album=%4,-metadata,date=%5,-metadata,genre=Speech,-vn,-acodec:a,libmp3lame,-ab,40k,-ar,32k,-ac,2,%2";
		ffmpegHash["mp3-32k-S"] = "%1,-id3v2_version,3,-write_xing,0,-metadata,title=%3,-metadata,artist=NHK,-metadata,album=%4,-metadata,date=%5,-metadata,genre=Speech,-vn,-acodec:a,libmp3lame,-ab,32k,-ar,32k,-ac,2,%2";
...
QString RecordingCore::json_paths[] = {
...
QString RecordingCore::json_paths2[] = { 
...
//				if ( Xml_koza == "NULL" && !(ui->checkBox_next_week2->isChecked()) )	continue;
	...
	if ( m_cancelRequested || isCanceled ) {
...
QDate RecordingCore::getBroadcastDate(int fiscalYear, int broadcastMonth, int broadcastDay){ 
...
// 探索範囲は 3月29日～4月4日
QDate RecordingCore::getNHKLectureStartDate(int fiscalYear) {
...
int RecordingCore::getNHKLectureFiscalYear(const QDate& date) {
    int year = date.year();
    // 今年の年度開始日
...
QStringList RecordingCore::formatBroadcastDates(const QStringList &dates)
{
    QStringList result;
...
QString RecordingCore::getFfmpegFolder(const QString &ffmpegPath) {
    QFileInfo fileInfo(ffmpegPath);
    return fileInfo.absolutePath(); // 親ディレクトリのパスを取得
}

// QDate → QString に変換（年/月/日の桁数指定 & 区切り文字指定）
QString RecordingCore::formatQDate(const QDate &date,
...
QStringList RecordingCore::extractAllDates(const QString &contentId) {
    QStringList dates;
...
// n番目のマッチを取得する関数（0ベース）
// 存在しない場合は空文字を返す
QString  RecordingCore::extractNthDate(const QString &contentId, int index) {
