...
//	setMinimumHeight( maximumHeight() - menuBar()->height() );
	setMaximumHeight( maximumHeight() - ( menuBar()->height()  ) * 2 );	// レコーディングボタンが表示されない問題対策　2024/06/06
	setMinimumHeight( maximumHeight() - ( menuBar()->height()  ) * 2 );	// レコーディングボタンが表示されない問題対策　2024/06/06
