...
//ScrambleDialog::ScrambleDialog( QString scramble, QWidget *parent )
    ...
    ui->setupUi(this);
	if( MainWindow::ouch_flag ) ui->checkBox_1->setChecked(true);
	...
	if ( MainWindow::ouch_flag ) ui->checkBox_1->setChecked(true);
	if ( ui->checkBox_1->isChecked() ) { MainWindow::ouch_flag = true; ui->checkBox_1->setChecked(true);} else { MainWindow::ouch_flag = false; ui->checkBox_1->setChecked(false); }
	if ( MainWindow::id_flag ) ui->checkBox->setChecked(true);
