...
inline constexpr auto SETTING_GEOMETRY = "geometry";            // QByteArray 型（ウィンドウ位置・サイズ）
inline constexpr auto SETTING_WINDOWSTATE = "windowState";      // QByteArray 型（ツールバーなどの状態）
