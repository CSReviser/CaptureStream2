...
* **A:　対応しております。最新版では初期状態で英語以外の語学講座を選択可能になっています。従来通り、任意番組ボタンに録音したい番組を設定することもできます。設定手順は[任意らじる聴き逃し番組設定](./SETTING_COURSES)を、対象講座は[対象講座と番組ID一覧](./courses_name)をご確認ください。**
...
* **Q:　32bit版はありますか？**
* **A:　あります。32bit版は配布しているzipのファイル名に「x86」という文字が含まれます。64bit版はファイル名に「x64」という文字が含まれます。**
