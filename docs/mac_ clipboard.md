...
【Universal Clipboardでファイル転送(Mac → iPhone)】
...
本手順では、Universal Clipboard（ユニバーサルクリップボード）を利用し、Mac でコピーした m4a 音声ファイルを iPhone に直接ペーストして転送する方法を説明する。
AirDrop と異なり、コピー → ペーストだけで転送できる。
