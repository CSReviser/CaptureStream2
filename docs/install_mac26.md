...
* **1.「MacCaptureStream2」 フォルダ内の 「CaptureStream2.app」を**  
   **「アプリケーション」フォルダ にドラッグ＆ドロップしてコピーする。**
   ...
   <img src="https://github.com/user-attachments/assets/8ca783b1-bad5-48c6-b724-1b92058f3c09" width="350"> 
...
* **[セキュリティ設定を無効化してアプリを開く(Apple Macユーザガイド)](https://support.apple.com/ja-jp/guide/mac-help/mh40617/mac)**       
...
### 7. ffmpeg の設定（必要に応じて）
* ** `ffmpeg`関係のエラーメッセージが表示される場合は下記を確認ください。**
* **語学講座CS2 の録音機能には `ffmpeg` が必要です。インストールされていない場合、以下の手順で導入してください。**
