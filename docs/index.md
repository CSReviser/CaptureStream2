...
* **『まいにちイタリア語』で【入門編】【初級編】となる不具合は[2023/04/01開発テスト版](./#開発テスト版-1)で根本対策済みです。**       
...
* **2026年度版リリース予定：**
  * **2026年04月第2週を予定**
  * **変更内容は[こちら](./#2026年度版用予定開発テスト版適用済)参照**
