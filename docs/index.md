...
* **2024/09/03版をリリースしました。今回の更新は必須ではありません。**
* **2024/06版以前から更新する場合は10桁の番組IDに再設定して下さい。任意番組設定で確認ボタンを押すと4桁のIDは10桁のIDに変換されます。変換されない場合は手動で変更してください。**
