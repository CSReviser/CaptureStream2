...
* **macOS Tahoe 26 がリリースされました。署名なしアプリのGatekeeperブロック回避方法はSequoiaと同じようです。Mac／macOS関連情報提供を継続お待ちしています。**
...
***
### ＜開発テスト版＞
* **[2025/06/08(macos-15)テスト版](./test_release)**
...
***
### ＜既知課題＞         
**※ 2025/09/12現在不具合は確認しておりません。**

### 次回リリース時適用予定：
* **macos-15テスト版ビルド**

### 2025年9月16日：
* **macOS 26リリース(Gatekeeper回避策はSequoiaと同じ)**
