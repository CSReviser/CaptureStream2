...
* **2025/05/31テスト版をリリースしました。GitHubでの実行ファイルのビルドからリリースファイル作成、アップロードを自動化したテスト版です。Qt6.9は語学講座CS2の開発環境Qtの2025/05現在の最新版です。**
...
***
### ＜開発テスト版＞
* **[GitHubリリース自動化テスト版](./test_release)**
...
***
### ＜既知課題＞         
**※ ubuntu(Linux)でwineを使ってWindows版を動作させた場合に「ホームページを表示」機能が動作しない不具合を確認しています。対応を検討中です。しばらくお待ちください。**
