...
* **macOS版でメニューバー表示問題の報告を頂いています。[テスト版その２](https://github.com/CSReviser/CaptureStream2/releases/download/20240604/CaptureStream2-MacOS-menubar-20240604-1.dmg)を作成しました。Macユーザーの動作確認協力に期待します。**
...
* ### **[CaptureStream2-MacOS-menubar-20240604-1.dmg](https://github.com/CSReviser/CaptureStream2/releases/download/20240604/CaptureStream2-MacOS-menubar-20240604-1.dmg)　※ MacOS版で縦方向の表示の調整を意図したテスト版です。**      
...
***
### ＜既知課題＞
**※ 2024/06/04版のmacOS版でメニューバー表示問題の報告を頂いています。[テスト版その２](https://github.com/CSReviser/CaptureStream2/releases/download/20240604/CaptureStream2-MacOS-menubar-20240604-1.dmg)を作成しました。Macユーザーの情報提供に期待します。2024/04/19 Ubuntu版で不具合報告を頂きましたが、現象を確認できていません。情報提供にご協力お願いします。**
