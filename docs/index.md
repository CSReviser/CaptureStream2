...
**[公式アプリ：NHKゴガク](https://www.nhk.or.jp/gogaku/app/)**  
  * **[3月30日メンテナンスのお知らせ](https://www.nhk.or.jp/gogaku/spwebcontent10/news.html)**     
...
* **コマンドラインで-noguiオプション、番組IDを指定すると前週分のサムネが不正となる不具合は[2023/03/28開発テスト版](./#開発テスト版-1)で修正済みです。**       
...
* **2026年度版リリース予定：**
  * **2026年04月第2〜3週頃を予定**
  * **変更内容は[こちら](./#次回リリース時適用予定)参照**
  * **Qt6.11([対応OSはこちら](./Qt_vs_OS))**
  * **事前にテスト版をリリースします。**
...
***
### ＜既知課題＞         
**※ 2026/03/29現在、既知の不具合は開発テスト版に改善適用済です。**

### 2026年度版用予定(開発テスト版適用済)：
* **Qt6.11対応**
* **Qt5実行ファイル作成終了**
* **macos-26ビルド移行**
