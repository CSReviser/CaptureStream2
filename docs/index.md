...
* **一部のAI検索サービス（Google AI等）において、[類似アプリ](./application)と『語学講座CS2』を混同する誤情報が拡散しています。[類似アプリ](./application)については各提供元にお問い合わせください。**
...
### 2025年10月中旬：
* **[Qt6.10環境構築](https://wiki.qt.io/Qt_6.10_Release)**
* **Qt6.10テスト版リリース**
* **データ定義分離**
...
### 2025年11月18日：
* **[Qt6.10.1リリース予定](https://wiki.qt.io/Qt_6.10_Release)**
