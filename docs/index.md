...
* **2026年度最新版は2026/04/07版です。開発環境はQt6.11を使っています。[QtとOSの対応はこちらで確認できます。](./Qt_vs_OS)**
* **類似アプリと混同など語学講座CS2に関するAI誤情報事例を[FAQのページ](./FAQ)にまとめました。**     
* **[高校講座夏期講座放送予定](https://edu.web.nhk/kokokoza/assets/pdf/kikan.pdf)：８月はラジオ高校講座英語科の放送は休止です。**     
...
***
### ＜既知課題＞         
**※ 2026/05/02現在、2026年度最新版(2026/04/07)での不具合は確認していません。**
