...
####     [こちらのリリースノート（ブログ）](./#実行ファイル-1)からMacintosh版をダウンロードしてください。2024/09/01現在トップページへの実行ファイルの掲載を見合わせています。[【MacOSユーザの方へ】](https://csreviser.github.io/CaptureStream2/macos)も参照下さい。
